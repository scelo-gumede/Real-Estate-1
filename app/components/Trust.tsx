...
export default function Trust(){
    ...
    return (
        <section className="bg-greyWhite space-y-5 py-20 text-grey px-10 lg:px-48">
             <h2 className="text-4xl   text-center font-extrabold">Trusted By 100 Million Buyers</h2>
